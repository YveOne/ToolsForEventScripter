...
require(JD_HOME + "/eventscripter/system/Array.random.js");
require(JD_HOME + "/eventscripter/system/local.js");

require(JD_HOME + "/eventscripter/api/getStopMarkedLink.js");
require(JD_HOME + "/eventscripter/api/moveGrabbedLinks.js");
require(JD_HOME + "/eventscripter/api/movePackageToDownloadlist.js");
require(JD_HOME + "/eventscripter/api/setMaxSimultaneDownloads.js");
...
var LinkRefresh = (function () {
    ...
    return function (overwriteCfg) {
        ...
        function handleLink(link) {
            ...
            var linkSpeed = link.getSpeed();

            if (cfg.abortSlow && linkDonePercent < 0.98 && linkDuration > cfg.abortSlowDelay) {
                var slowHostSpeed = cfg.abortSlowHosts[link.getHost()];
                if (linkSpeed < cfg.abortSlowSpeed || (slowHostSpeed !== undefined && linkSpeed < slowHostSpeed)) {
                    link.abort();
                }
            }
